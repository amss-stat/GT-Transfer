...
for (i in 1:1000){
  ...
  tran_noselect = GT_tran(m,k,pi_0,pi_1,m_1,p_tilde_j,v_tilde_j, screen = F)
    
  p_tilde_data = c(p_tilde_data, p_tilde)
  p_hat_data = c(p_hat_data, tran$p_hat)
  p_hat_noselect_data = c(p_hat_noselect_data, tran_noselect$p_hat)
}

MSE_tilde=sum((p_tilde_data-p)^2)/1000
MSE_hat=sum((p_hat_data-p)^2)/1000
MSE_hat_noselect=sum((p_hat_noselect_data-p)^2)/1000

MSE_tilde/MSE_hat
MSE_tilde/MSE_hat_noselect
...
for (i in 1:1000){
  ...
  tran = GT_tran(m,k,pi_0,pi_1,m_1,p_tilde_j,v_tilde_j,w = 1,eta = NULL)
  tran_noselect = GT_tran_noselect(m,k,pi_0,pi_1,m_1,p_tilde_j,v_tilde_j)
