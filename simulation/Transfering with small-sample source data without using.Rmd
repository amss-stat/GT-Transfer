...
for (i in 1:1000){
  ...
  tran_bad = GT_tran(m,k,pi_0,pi_1,m_1,p_tilde_j,v_tilde_j, screen = F)
  
  tran_bad_retest = GT_tran_retest(m,k,pi_0,pi_1,S0,S1,m_1,m_1i,p_tilde_j,v_tilde_j, screen = F)
